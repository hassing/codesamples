...
class ShaderCache {
private:
    std::map<uint32_t, GLuint> _uniforms;
    GLuint _program;
public:
    ShaderCache(GLuint program);
    GLint UniformLocation(const char* name, uint32_t id);
};

// Compile time hashing of uniform names
//
// Source https://gist.github.com/iwanders/8e1cb7b92af2ccf8d1a73450d771f483
namespace crcdetail {
...
#define UNIFORMNAME(x) x, CRC32_STR(x)
